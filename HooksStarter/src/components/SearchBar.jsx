function SearchBar({searchValue,searchValueFunction}){
    return(
        <div className="w-full mt-6 md:w-1/2 lg:max-w-md m-auto">
            <form className="flex px-4 border-2 border-gray-300 
            ...
            onSubmit={(e)=>{e.preventDefault()}}>
                ...
                <button id="searchSubmit" aria-laber="Click to submit search" type="submit">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#000000" className="w-8 h-8 text-gray-500 h-4 w-4 fill-current">
