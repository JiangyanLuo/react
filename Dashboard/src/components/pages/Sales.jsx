...
function Sales() {
  ...
  return (<main className="grid pl-14 grid-cols-2 grid-rows-2 h-screen gap-8 w-4/5 m-auto mt-4 mb-8">
    <AreaGraph
    ...
    <KpiGrid>
      <KpiBlock
        ...
        title="conversion"
        time="today"
        value={ConversionRate(salesTotals.ytdTotals.traffic, salesTotals.ytdTotals.transactions)}
        targetValue={20}
      />
      <KpiBlock
    ...
    <BarGraph
      ...
      totalValue={
        category === "ADS"
          ? formatMoneyValue(
              getYearAds(getYtdValue(salesTotals.sales), salesTotals.ytdTotals.transactions)
            )
          : getYearUpt(salesTotals.ytdTotals.units, salesTotals.ytdTotals.transactions)
      }
